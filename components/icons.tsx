// Central icon registry. All SVG icons used in this project live here.
// Source: Heroicons v2 (MIT) — https://heroicons.com, solid / 20px variants.
// To add a new icon: copy the SVG paths here and export a named component.
// Never inline SVG directly in page/component files — import from this file instead.

type Props = { className?: string }

const base = 'w-4 h-4'

export function IconEye({ className = base }: Props) {
  return (
...
export function IconEyeOff({ className = base }: Props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
...
export function IconExternalLink({ className = base }: Props) {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className={className}>
...
export function IconQrCode({ className = base }: Props) {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className={className}>
...
export function IconPencil({ className = base }: Props) {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className={className}>
...
export function IconChevronUp({ className = base }: Props) {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className={className}>
...
export function IconChevronDown({ className = base }: Props) {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className={className}>
...
export function IconGrid({ className = base }: Props) {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className={className}>
